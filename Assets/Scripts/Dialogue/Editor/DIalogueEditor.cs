...
namespace Dialogue.Editor
{
    public class DialogueEditor : EditorWindow
    {
        ...
        private void ProcessEvents()
        {
            ...
            {
                dragginNode = GetNodeAtPoint(Event.current.mousePosition + scrollPosition);
                if(dragginNode != null)
                {
                    dragginOffset = dragginNode.GetRect().position - Event.current.mousePosition;
            ...
            else if(Event.current.type == EventType.MouseDrag && dragginNode != null)
            {
                ...
                dragginNode.SetPosition(Event.current.mousePosition + dragginOffset);
